...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Generate ETTh dataset")
    parser.add_argument("--file_path", help="path of dataset file", type=str, default='./origin/ETT-small/ETTh1.csv')
    ...
    parser.add_argument("--dataset_name", help="生成数据集的名称", type=str, default="ETTh1")
    parser.add_argument(
