...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Generate Solar dataset")
    parser.add_argument("--file_path", help="path of dataset file", type=str, default='./origin/Solar/solar_AL.txt')
    parser.add_argument(
