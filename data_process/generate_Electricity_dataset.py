...
if __name__ == "__main__":
    ...
    parser.add_argument("--file_path", help="path of dataset file", type=str, default='./origin/Electricity/LD2011_2014.txt')
    parser.add_argument(
    ...
    selected_as_val = satisfic_days[train_num:val_num+train_num]
    print(f"months selected as val set are {selected_as_val}")
    selected_as_test = satisfic_days[val_num+train_num:]
