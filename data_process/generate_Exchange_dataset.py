...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Generate Exchange dataset")
    parser.add_argument("--file_path", help="path of dataset file", type=str, default='./origin/Exchange/exchange_rate.csv')
    parser.add_argument(
