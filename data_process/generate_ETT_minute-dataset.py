...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Generate ETTm dataset")
    parser.add_argument("--file_path", help="path of dataset file", type=str, default='./origin/ETT-small/ETTm2.csv')
    ...
    parser.add_argument("--dataset_name", help="生成数据集的名称", type=str, default="ETTm2")
    parser.add_argument(
