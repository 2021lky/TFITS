...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Generate Weather dataset")
    parser.add_argument("--file_path", help="path of dataset file", type=str, default='./origin/Weather/weather.csv')
    parser.add_argument("--artificial_missing_rate", help="人工设置缺失率，在测试集和验证集中设置", type=float, default=0.1)
    parser.add_argument("--seq_len", help="sequence length", type=int, default=144)
    parser.add_argument("--dataset_name", help="生成数据集的名称", type=str, default="Weather")
    parser.add_argument(
